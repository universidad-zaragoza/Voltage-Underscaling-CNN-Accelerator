...
print(Df_Tecn)
Df_Tecn.to_excel('MoRS/Modelo3_col_8_'+ str(vol)+'/Analisis_Resultados/Palabras_x_tipo/Mask_less_LHO_L_F(HO)/test_direccion_' + str(inc)+'.xlsx', sheet_name='fichero_707', index=False)
...
# # PilotNet
    ...
    for i in range(len(Funcion)):
        ...
        error_mask_new, locs = Funcion[i](error_mask_less_VBW, locs_less_VBW)
