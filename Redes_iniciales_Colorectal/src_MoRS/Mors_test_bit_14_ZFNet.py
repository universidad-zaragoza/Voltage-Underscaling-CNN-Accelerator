...
# buf_test_shift.to_excel('MoRS/Modelo3_mas_fallos_col_8_experimentos/estatics/ZFNet_test_shift_ratio_affect_all actvs.xlsx', sheet_name='fichero_707', index=False)
#
...
print(df_concat)
df_concat.to_excel('MoRS/Modelo3_mas_fallos_col_8_experimentos/estatics/ZFNet_new_bins_test_shift_bit_intervalos_sinfallos.xlsx', sheet_name='fichero_707', index=False)
