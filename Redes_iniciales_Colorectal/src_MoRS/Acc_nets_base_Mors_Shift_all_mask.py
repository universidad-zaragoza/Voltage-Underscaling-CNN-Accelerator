...
from funciones import compilNet, same_elements,buffer_vectores,Base,IsoAECC,ECC, Flip,FlipPatchBetter,FlipPatch,ShiftMask,WordType
...
#     print(str() + ' operación completada VGG16: ', datetime.now().strftime("%H:%M:%S"))
    ...
    print('Acc_ZFNet',Funcion[i],Acc_ZFNet)
    del error_mask_new
