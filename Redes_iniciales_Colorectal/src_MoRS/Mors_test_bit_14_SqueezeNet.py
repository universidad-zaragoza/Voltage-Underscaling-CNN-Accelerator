...
Net = GetNeuralNetworkModel('SqueezeNet', (224, 224, 3), 8, aging_active=activation_aging,faulty_addresses=locs, masked_faults=error_mask_new,
...
# buf_test_shift.to_excel('MoRS/Modelo3_mas_fallos_col_8_experimentos/estatics/SquezNet_test_shift_ratio_affect_all actvs.xlsx', sheet_name='fichero_707', index=False)
#
...
print(df_concat)
df_concat.to_excel('MoRS/Modelo3_mas_fallos_col_8_experimentos/estatics/squez_new_bins_test_LO_mask_intervalos.xlsx', sheet_name='fichero_707', index=False)
...
# buf_test_shift.columns = ['Capa','values_af','locs_affected']
# print('buf_test_shift', buf_test_shift)
# buf_test_shift.to_excel('MoRS/Modelo3_mas_fallos_col_8_experimentos/estatics/test_shift_ratio_affect_sin_iny_fallos.xlsx', sheet_name='fichero_707', index=False)
#
#
#
