...
from Stats import WeightQuantization,IntroduceFaultsInWeights,GenerateFaultsList,CheckAccuracyAndLoss,QuantizationEffect
...
# Net = GetNeuralNetworkModel('VGG16', (224, 224, 3), 8, word_size=word_size, aging_active=activation_aging, frac_size=afrac_size, batch_size=testBatchSize)
...
#
#
# df = QuantizationEffect('VGG16',test_dataset,wgt_dir,(224,224,3),8,testBatchSize,aging_active=activation_aging)
#
# quantizacion=pd.DataFrame(df)
#
# quantizacion.to_excel('quantizacion.xlsx', sheet_name='fichero_707', index=False)
# save_obj(df,'VGG16/métricas/Quantization_VGG16')
#
# breakpoint()
acc_list = []
...
#from Nets_original import GetNeuralNetworkModel
Net = GetNeuralNetworkModel('VGG16', (224, 224, 3), 8, aging_active=activation_aging,faulty_addresses=locs, masked_faults=error_mask_new,
...
## Analizando todas las activaciones
...
# buf_test_shift.to_excel('MoRS/Modelo3_mas_fallos_col_8_experimentos/estatics/VGG16_test_shift_ratio_affect_all actvs.xlsx', sheet_name='fichero_707', index=False)
#
#
...
print(df_concat)
df_concat.to_excel('MoRS/Modelo3_mas_fallos_col_8_experimentos/estatics/bins/VGG16_new_bins_test_LO_mask_bit_intervalos.xlsx', sheet_name='fichero_707', index=False)
...
# buf_test_shift.columns = ['Capa','values_af','locs_affected']
# print('buf_test_shift', buf_test_shift)
# buf_test_shift.to_excel('MoRS/Modelo3_mas_fallos_col_8_experimentos/estatics/VGG16_test_shift_ratio_affect.xlsx', sheet_name='fichero_707', index=False)
#
#
