...
from funciones import compilNet, same_elements,buffer_vectores,Base,IsoAECC,ECC, Flip,FlipPatchBetter,ShiftMask,ScratchPad
...
DF_Funcion=pd.DataFrame(['Base','IsoAECC', 'ECC', 'Flip','FlipPatchBetter','FlipPatch'])
...
Acc_all_exp= pd.concat([Df_change_words,DF_Funcion,Acc_AlexNet,Acc_DenseNet,Acc_MobileNet,Acc_SqueezeNet,Acc_VGG16,Acc_ZFNet],axis=1, join='outer')
Acc_all_exp.columns = ['words_change','Técnica','AlexNet', 'DenseNet', 'MobileNet', 'SqueezeNet', 'VGG16', 'ZFNet']
print(Acc_all_exp)
Acc_all_exp.to_excel('MoRS/Modelo3_col_8_0.54/Analisis_Resultados/estatics/ACC_all_Experiment_modelo_0_test_comprob.xlsx', sheet_name='fichero_707', index=False)
