...
# print(df_concat)
# df_concat.to_excel('MoRS/Modelo3_mas_fallos_col_8_experimentos/estatics/AlexNet_test_shift_bit_intervalos_sin_fallos.xlsx', sheet_name='fichero_707', index=False)
#
#
#
#
