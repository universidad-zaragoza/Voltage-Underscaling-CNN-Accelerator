...
Net = GetNeuralNetworkModel('VGG16', (224, 224, 3), 8, aging_active=activation_aging,
...
F_patch = GetNeuralNetworkModel('VGG16', (224, 224, 3), 8, faulty_addresses=locs, masked_faults=error_mask_new,
...
S_Patch = GetNeuralNetworkModel('VGG16', (224, 224, 3), 8, faulty_addresses=locs, masked_faults=error_mask_new,
                              aging_active=activation_aging, word_size=word_size, frac_size=afrac_size,
                              batch_size=testBatchSize)
...
Net_Shift = GetNeuralNetworkModel('VGG16', (224, 224, 3), 8, faulty_addresses=locs, masked_faults=error_mask_new,
                              aging_active=activation_aging, word_size=word_size, frac_size=afrac_size,
                              batch_size=testBatchSize)
...
print(test_Mors)
test_Mors.to_excel('MoRS/Modelo3_mas_fallos_col_8_experimentos/estatics/VGG16_ratio_by_layers_by_technique_test_solo LO.xlsx', sheet_name='fichero_707', index=False)
...
# print(test_Mors)
# test_Mors.to_excel('MoRS/Modelo3_mas_fallos_col_8_experimentos/estatics/VGG16_ratio_by_layers_Test_shift_all_dataset.xlsx', sheet_name='fichero_707', index=False)
#
...
# print(test_Mors)
# test_Mors.to_excel('MoRS/Modelo3_mas_fallos_col_8_experimentos/estatics/VGG_Test_shift_all_dataset.xlsx', sheet_name='fichero_707', index=False)
