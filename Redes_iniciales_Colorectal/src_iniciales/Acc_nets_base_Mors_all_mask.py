...
#Funcion= [Base, FlipPatchBetter, ScratchPad]
DF_Funcion = pd.DataFrame(['Base', 'FlipPatchBetter','ScratchPad'])
#DF_Funcion = pd.DataFrame(['Base', 'IsoAECC', 'ECC', 'Flip', 'FlipPatchBetter','ScratchPad'])
#Funcion = [Base, FlipPatchBetter]
#DF_Funcion = pd.DataFrame(['Base', 'FlipPatchBetter'])

DF_Funcion.to_excel('MoRS/Modelo3_col_8_'+ str(vol)+'/Analisis_Resultados/estatics/test_direccion.xlsx', sheet_name='fichero_707', index=False)
...
for j , vol  in enumerate(voltajes):
    ...
    for inc in range(1):
        ...
        Funcion = [Base,  FlipPatchBetter, ScratchPad, Shift]
        ...
        for i in range(len(Funcion)):
            ...
            error_mask_new, locs,locs_modif,word_change = Funcion[i](error_mask, locs)
        ...
        # print(Acc_all_exp)
        # Acc_all_exp.to_excel( 'MoRS/Modelo3_col_8_' + str(vol) + '/Analisis_Resultados/estatics/ACC_all_Experiment_modelo_' + str(
