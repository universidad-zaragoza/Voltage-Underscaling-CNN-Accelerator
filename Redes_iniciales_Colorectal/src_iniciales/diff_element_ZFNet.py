...
Net1 = GetNeuralNetworkModel('ZFNet', (224,224,3), 8, aging_active=activation_aging,
...
if Cargar_errores:
    locs = load_obj('Data/Fault Characterization/variante_mask_vc_707/error_mask_x/error_mask_x4/vc_707/locs_054')
    error_mask = load_obj('Data/Fault Characterization/variante_mask_vc_707/error_mask_x/error_mask_x4/vc_707/error_mask_054')
...
with pd.ExcelWriter('ZFNet/ZFNet_ratio_part_int_base.xlsx') as writer:
