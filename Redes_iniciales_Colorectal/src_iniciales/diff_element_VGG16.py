...
if Cargar_errores:
    locs = load_obj(
        'Data/Fault Characterization/variante_mask_vc_707/mask_invert_volteada_x/mask_invert_volteada/vc_707/locs_054')
...
with pd.ExcelWriter('VGG16/nume_actv_diffe_VGG16_volteo_invert_redond.xlsx') as writer:
