...
for i in range(7):
    ...
    loss, acc = CheckAccuracyAndLoss('DenseNet', test_dataset, wgt_dir, output_shape=8, input_shape=(224, 224, 3),
                                     ...
                                     weights_faults=False,    faulty_addresses=locs, masked_faults=error_mask)
...
buf_cero.to_excel('DenseNet_comprob_acc_error_All_of_All.xlsx', sheet_name='fichero_707', index=False)
