...
#error_mask_H_L_O,VBW = VeryBadWords(error_mask,locs)
#print( 'VBW', VBW)
...
# with pd.ExcelWriter('AlexNet/métricas/AlexNet_reads_and_write_num_adress_Mors_mas_orig.xlsx') as writer:
...
#
# with pd.ExcelWriter('AlexNet/métricas/AlexNet_reads_and_write_VBW_Mors_mask_origina.xlsx') as writer:
...
# with pd.ExcelWriter('AlexNet/métricas/new_for_max_read_x_cada_16_direcciones_PE_16_Mors.xlsx') as writer:
