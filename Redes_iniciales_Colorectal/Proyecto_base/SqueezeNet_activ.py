...
Data    = GetReadAndWrites(SqueezeNet,Indices,1024*1024,10,CNN_gating=True,network_name='SqueezeNet')
stats    = {'Lecturas': Data['Reads'],'Escrituras': Data['Writes']}
...
for i, j in enumerate(ficheros):
    ...
    loss,acc_1   = CheckAccuracyAndLoss('SqueezeNet', test_dataset, wgt_dir, output_shape=8, input_shape = (224,224,3),
                                            act_frac_size = 9, act_int_size = 6, wgt_frac_size = 15, wgt_int_size = 0,
                                            batch_size=testBatchSize, verbose = 0, aging_active = True, weights_faults = False,
                                            faulty_addresses = locs, masked_faults = error_mask)
    #
    # loss,acc_w_1   = CheckAccuracyAndLoss('SqueezeNet', test_dataset, wgt_dir, output_shape=8, input_shape = (224,224,3),
    #                                         act_frac_size = 9, act_int_size = 6, wgt_frac_size = 15, wgt_int_size = 0,
    #                                         batch_size=testBatchSize, verbose = 0, aging_active = False, weights_faults = True,
    #                                         faulty_addresses = locs, masked_faults = error_mask)

    # loss,acc_a_w_1   = CheckAccuracyAndLoss('SqueezeNet', test_dataset, wgt_dir, output_shape=8, input_shape = (224,224,3),
    #                                         act_frac_size = 9, act_int_size = 6, wgt_frac_size = 15, wgt_int_size = 0,
    #                                         batch_size=testBatchSize, verbose = 0, aging_active = True, weights_faults = True,
    #                                         faulty_addresses = locs, masked_faults = error_mask)
...
for i, j in enumerate(ficheros):
    ...
    loss,acc_1_0   = CheckAccuracyAndLoss('SqueezeNet', test_dataset, wgt_dir, output_shape=8, input_shape = (224,224,3),
                                            act_frac_size = 9, act_int_size = 6, wgt_frac_size = 15, wgt_int_size = 0,
                                            batch_size=testBatchSize, verbose = 0, aging_active = True, weights_faults = False,
                                            faulty_addresses = locs, masked_faults = error_mask)
    #
    # loss,acc_w_1_0   = CheckAccuracyAndLoss('SqueezeNet', test_dataset, wgt_dir, output_shape=8, input_shape = (224,224,3),
    #                                         act_frac_size = 9, act_int_size = 6, wgt_frac_size = 15, wgt_int_size = 0,
    #                                         batch_size=testBatchSize, verbose = 0, aging_active = False, weights_faults = True,
    #                                         faulty_addresses = locs, masked_faults = error_mask)

    # loss,acc_a_w_1_0   = CheckAccuracyAndLoss('SqueezeNet', test_dataset, wgt_dir, output_shape=8, input_shape = (224,224,3),
    #                                         act_frac_size = 9, act_int_size = 6, wgt_frac_size = 15, wgt_int_size = 0,
    #                                         batch_size=testBatchSize, verbose = 0, aging_active = True, weights_faults = True,
    #                                         faulty_addresses = locs, masked_faults = error_mask)
    #
...
# buf_cero.to_excel('resultado_SqueezeNet.xlsx', sheet_name='fichero_707', index=False)


#Acc_a_w_1_0 =pd.DataFrame(Accs_a_w_1_0)
buf_cero = pd.concat([Acc,Acc_1,Acc_1_0], axis=1, join='outer')
buf_cero.columns =[ 'Acc_a_cero', 'Acc_a_uno', 'Acc_a_uno_cero']
buf_cero.to_excel('resultado_SqueezeNet_A.xlsx', sheet_name='fichero_707', index=False)
