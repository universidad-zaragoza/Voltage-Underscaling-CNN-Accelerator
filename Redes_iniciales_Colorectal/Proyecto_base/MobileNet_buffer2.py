...
Data    = GetReadAndWrites(MobileNet,Indices,817216,10,CNN_gating=False)
stats   = {'Lecturas': Data['Reads'],'Escrituras': Data['Writes']}
Baseline_Acceses   = pd.DataFrame(stats).reset_index(drop=False)
Data    = GetReadAndWrites(MobileNet,Indices,817216,10,CNN_gating=True)
stats    = {'Lecturas': Data['Reads'],'Escrituras': Data['Writes']}
...
buf_cero.to_excel('MobileNet_buffer_2.xlsx', sheet_name='fichero_707_buffer2', index=False)
