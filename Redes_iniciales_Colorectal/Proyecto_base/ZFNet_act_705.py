...
save_obj(Accs_x,'Data/Errors/ZFNet/Colorectal Dataset/Accs_x')
...
# buf_cero.to_excel('resultado_ZFNet.xlsx', sheet_name='fichero_707', index=False)
...
buf_cero.to_excel('ZFnet_act.xlsx', sheet_name='ceros_705', index=False)
Acc.head()
