...
if tf.test.gpu_device_name():
    ...
    print("GPU version for TensorFlow not installed")
...
df = QuantizationEffect('Inception',test_ds,wgt_dir,(150,150,3),10,batch_size)
#
#
...
loss,acc_x   = CheckAccuracyAndLoss('Inception', test_ds, wgt_dir, output_shape=8, input_shape = (150,150,3),
                                      act_frac_size = 7, act_int_size = 8, wgt_frac_size = 13, wgt_int_size = 12,
                                      batch_size=batch_size, verbose = 1, aging_active = activation_aging, weights_faults = True)
print(acc_x)
Accs_x.append(acc_x)

# ResNetmodel = GetNeuralNetworkModel('ResNet',(150,150,3),8, quantization = False, aging_active=activation_aging)
# ResNetmodel.summary()
# #ResNetmodel.load_weights('../weights/ResNet50/weights.data')
# #WeightQuantization(model = ResNetmodel, frac_bits = wfrac_size, int_bits = wint_size)
...
#     outputs1 = get_all_outputs(ResNetmodel, image)
#     index = index + 1
...
# outputs1= get_all_outputs(ResNetmodel,X[0])
#
# layer_size = []
# layer_name=[]
...
#     if ResNetmodel.layers[index].__class__.__name__=='Conv2D':
#         layer_name.append(ResNetmodel.layers[index].__class__.__name__)
#         b = outputs1[index].size
#         print(b)
#         layer_size.append(b)
#         print('tamaño de la capa ', ResNetmodel.layers[index].__class__.__name__)
#         print('es', b)
# c = np.sum(layer_size)
...
# result.to_excel('Resnet_conv_size.xlsx', sheet_name='resnet', index=False)
#
#
# exit()
...
# score = ResNetmodel.evaluate(test_ds, verbose=1)

#print('Test loss:', score[0])
#print('Test accuracy:', score[1])

# for index,layer in enumerate(ResNetmodel.layers):
...
# df = QuantizationEffect('ResNet',test_ds,wgt_dir,(150,150,3),8,batch_size)
# save_obj(df,'Data/Quantization/resnet/Quantization_train_ds')
...
#
# loss,acc_x   = CheckAccuracyAndLoss('ResNet', test_ds, wgt_dir, output_shape=8, input_shape = (150,150,3),
...
error_mask = load_obj('Data/Fault Characterization/variante_mask_vc_707/High_order/vc_707/error_mask_058')
locs = load_obj('Data/Fault Characterization/variante_mask_vc_707/High_order/vc_707/locs_058')
...
loss,acc   = CheckAccuracyAndLoss('Inception', test_ds, wgt_dir, output_shape=8, input_shape = (150,150,3),
                                            ...
                                            batch_size=batch_size, verbose = 0, aging_active = activation_aging, weights_faults = True,
...
#                                             faulty_addresses = locs, masked_faults = error_mask)
#
#     loss_w,acc_w   = CheckAccuracyAndLoss('ResNet', test_ds, wgt_dir, output_shape=8, input_shape = (150,150,3),
#                                             act_frac_size = 11, act_int_size = 4, wgt_frac_size = 14, wgt_int_size = 1,
#                                             batch_size=batch_size, verbose = 0, aging_active = True, weights_faults = True,
#                                             faulty_addresses = locs, masked_faults = error_mask)
#
#     loss_a_w,acc_a_w   = CheckAccuracyAndLoss('ResNet', test_ds, wgt_dir, output_shape=8, input_shape = (150,150,3),
#                                             act_frac_size = 11, act_int_size = 4, wgt_frac_size = 14, wgt_int_size = 1,
...
# buf_cero.to_excel('ResNet_fichero_alterado.xlsx', sheet_name='fichero_707_054', index=False)
# print(buf_cero)
