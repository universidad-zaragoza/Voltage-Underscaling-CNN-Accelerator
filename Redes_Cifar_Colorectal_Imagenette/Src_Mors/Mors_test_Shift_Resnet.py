...
activation_aging = [False] * 22
#
Net = GetNeuralNetworkModel('ResNet', (150,150,3), 8, aging_active=activation_aging,
...
F_patch = GetNeuralNetworkModel('ResNet', (150,150,3), 8, faulty_addresses=locs, masked_faults=error_mask_new,
...
S_Patch = GetNeuralNetworkModel('ResNet', (150,150,3), 8, faulty_addresses=locs, masked_faults=error_mask_new,
                             aging_active=activation_aging, word_size=word_size, frac_size=afrac_size,
                             batch_size=batch_size)
...
Net_Shift = GetNeuralNetworkModel('ResNet', (150,150,3), 8, faulty_addresses=locs, masked_faults=error_mask_new,
                             aging_active=activation_aging, word_size=word_size, frac_size=afrac_size,
                             batch_size=batch_size)
...
print(test_Mors)
test_Mors.to_excel('MoRS/Modelo3_mas_fallos_col_8_experimentos/estatics/ResNet_capa266_ratio_by_layers_by_technique_test_solo LO.xlsx', sheet_name='fichero_707', index=False)
...
# print(test_Mors)
# test_Mors.to_excel('MoRS/Modelo3_mas_fallos_col_8_experimentos/estatics/ResNet_ratio_by_layers_Test_shift_all_dataset.xlsx', sheet_name='fichero_707', index=False)
...
#     index = index + 1
# total_shift = np.sum(diff_sum_Shift)
# df_diff_shift = pd.DataFrame(total_shift)
# #diff_sum_Shift.append(total_shift)
# total_F_p = np.sum(diff_sum_FP)
# df_diff_F_P = pd.DataFrame(total_F_p)
# #diff_sum_FP.append(total_F_p)
# #df_diff_shift = pd.DataFrame(diff_sum_Shift)
# #df_diff_F_P = pd.DataFrame(diff_sum_FP)
# test_Mors = pd.concat([df_diff_F_P,df_diff_shift], axis=1, join='outer')
# test_Mors.columns = ['df_diff_F_P','df_diff_shift']
# test_Mors.to_excel('MoRS/Modelo3_mas_fallos_col_8_experimentos/estatics/ResNet50_Test_shift_all_dataset.xlsx', sheet_name='fichero_707', index=False)
...
# #
# # Net2 = GetNeuralNetworkModel('ResNet50', (150,150,3), 8, faulty_addresses=locs, masked_faults=error_mask,
...
# # with pd.ExcelWriter('ResNet50/métricas/ResNet50_diff_softmax.xlsx') as writer:
...
# acc_media_comprobacion.columns = ['media_diff','ACC']
# print(buf_same_elemen)
# with pd.ExcelWriter('ResNet50/métricas/ResNet50_diff_F_P_16xxx.xlsx') as writer:
#     buf_same_elemen.to_excel(writer, sheet_name='softmax_exp', index=False)
#     acc_media_comprobacion.to_excel(writer, sheet_name='acc_media_comprobacion', index=False)
