...
Net = GetNeuralNetworkModel('Inception', (150,150,3), 8, aging_active=activation_aging,faulty_addresses=locs, masked_faults=error_mask_x,
...
write_layer = [2, 6, 12, 18, 20, 26, 27, 34, 40, 51, 52, 63, 64, 67, 73, 74, 81, 90, 91, 94, 95, 103, 116, 117, 118, 119, 126, 135, 136,
 139, 140, 161, 162, 163, 164, 171, 180, 181, 184, 185, 206, 207, 208, 209, 216, 225, 226, 229, 230, 251, 252, 253, 254, 261,
 267, 270, 271, 280, 281, 282, 289, 295, 298, 299, 306, 307, 321, 326, 327, 328, 329, 342, 343, 344, 345, 352, 358, 369, 370,
 384, 405, 406, 407, 408, 415, 421, 432, 433, 447, 468, 469, 470, 471, 478, 484, 495, 496, 510, 531, 532, 533, 534, 541, 547,
 558, 559, 573, 594, 595, 596, 597, 604, 610, 621, 622, 636, 657, 658, 659, 660, 667, 673, 684, 685, 699, 720, 721, 722, 723,
 730, 736, 747, 748, 761, 762, 763, 770, 776, 785, 786, 787, 788, 797, 818, 819, 820, 821, 822, 823, 834, 840, 851, 852, 858,
 859, 860, 861, 890, 891, 898, 904, 915, 916, 925, 950, 951, 954, 955, 958, 962]
...
# buf_test_shift.to_excel('MoRS/Modelo3_mas_fallos_col_8_experimentos/estatics/Inception_test_shift_ratio_affect_all actvs.xlsx', sheet_name='fichero_707', index=False)
#
# #
# #
# #
...
# print(df_concat)
# df_concat.to_excel('MoRS/Modelo3_mas_fallos_col_8_experimentos/estatics/Inception_new_bins_test_shift_bit_intervalos_sinfallos.xlsx', sheet_name='fichero_707', index=False)
#

### Solo para las activaciones de los locs(direccion de memoria) afectado por los fallos
#
frac_size = 7
mask = [16384]
mask=np.array(16384)
...
buf_test_shift.columns = ['Capa','values_af','locs_affected']
print('buf_test_shift', buf_test_shift)
buf_test_shift.to_excel('MoRS/Modelo3_mas_fallos_col_8_experimentos/estatics/Inception_test_shift_ratio_affect.xlsx', sheet_name='fichero_707', index=False)
