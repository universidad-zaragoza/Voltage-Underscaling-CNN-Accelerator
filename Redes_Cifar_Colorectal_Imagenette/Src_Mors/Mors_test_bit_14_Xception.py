...
Net = GetNeuralNetworkModel('Xception', (150,150,3), 8, aging_active=activation_aging,faulty_addresses=locs, masked_faults=error_mask_x,
...
buf_test_shift.to_excel('MoRS/Modelo3_mas_fallos_col_8_experimentos/estatics/Xception_test_shift_ratio_affect.xlsx', sheet_name='fichero_707', index=False)
