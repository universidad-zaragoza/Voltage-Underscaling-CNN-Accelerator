...
def DifferenceOuts(outputs, outputs1,outputs2):
    ...
    test_Mors.to_excel('MoRS/Modelo3_mas_fallos_col_8_experimentos/estatics/Xcept_Test_shift.xlsx', sheet_name='fichero_707', index=False)
...
Net = GetNeuralNetworkModel('Xception', (150,150,3), 8, aging_active=activation_aging,
...
F_patch = GetNeuralNetworkModel('Xception', (150,150,3), 8, faulty_addresses=locs, masked_faults=error_mask_new,
...
S_Patch = GetNeuralNetworkModel('Xception', (150,150,3), 8, faulty_addresses=locs, masked_faults=error_mask_new,
                             aging_active=activation_aging, word_size=word_size, frac_size=afrac_size,
                             batch_size=batch_size)
...
Net_Shift = GetNeuralNetworkModel('Xception', (150,150,3), 8, faulty_addresses=locs, masked_faults=error_mask_new,
                             aging_active=activation_aging, word_size=word_size, frac_size=afrac_size,
                             batch_size=batch_size)
...
print(test_Mors)
test_Mors.to_excel('MoRS/Modelo3_mas_fallos_col_8_experimentos/estatics/Xception_ratio_by_layers_by_technique_test_solo LO.xlsx', sheet_name='fichero_707', index=False)
...
# print(test_Mors)
# test_Mors.to_excel('MoRS/Modelo3_mas_fallos_col_8_experimentos/estatics/Xception_ratio_by_layers_Test_shift_all_dataset.xlsx', sheet_name='fichero_707', index=False)
#
# #index = 1
#
...
# test_Mors.to_excel('MoRS/Modelo3_mas_fallos_col_8_experimentos/estatics/Xception_Test_shift_all_dataset.xlsx', sheet_name='fichero_707', index=False)
...
# acc_media_comprobacion.columns = ['media_diff','ACC']
# print(buf_same_elemen)
# with pd.ExcelWriter('Xception/métricas/Xception_diff_F_P_16xxx.xlsx') as writer:
#     buf_same_elemen.to_excel(writer, sheet_name='softmax_exp', index=False)
#     acc_media_comprobacion.to_excel(writer, sheet_name='acc_media_comprobacion', index=False)
