...
Net1 = GetNeuralNetworkModel('ResNet', (150,150,3), 8, aging_active=activation_aging,
...
#
#
# Net2 = GetNeuralNetworkModel('ResNet', (150,150,3), 8, faulty_addresses=locs, masked_faults=error_mask,
...
# with pd.ExcelWriter('ResNet/métricas/ResNet_diff_softmax.xlsx') as writer:
...
acc_media_comprobacion.columns = ['media_diff','ACC']
print(buf_same_elemen)
with pd.ExcelWriter('ResNet/métricas/ResNet_diff_softmax_F_P_16xx.xlsx') as writer:
    buf_same_elemen.to_excel(writer, sheet_name='softmax_exp', index=False)
    acc_media_comprobacion.to_excel(writer, sheet_name='acc_media_comprobacion', index=False)
