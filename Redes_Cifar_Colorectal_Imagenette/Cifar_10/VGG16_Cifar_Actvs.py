...
VGG16 = GetNeuralNetworkModel('VGG16',(32,32,3),10, quantization = False, aging_active=activation_aging)
...
#df = QuantizationEffect('VGG16',test_ds,wgt_dir,(32,32,3),10,batch_size)
#
#
#quantizacion=pd.DataFrame(df)
#
#quantizacion.to_excel('quantizacion.xlsx', sheet_name='fichero_707', index=False)
#save_obj(df,'Data/Quantization/VGG16_cifar/Quantization_MobileNet_cifar')

# print(str()+' Quantización completada VGG16_Cifar: ', datetime.now().strftime("%H:%M:%S"))

VGG16.load_weights(wgt_dir)

# score = VGG16.evaluate(test_ds, verbose=1)
#
...
# #
# #
# score = VGG16.evaluate(train_ds, verbose=1)
# #
...
for i in range(1):
    ...
    loss, acc = CheckAccuracyAndLoss('VGG16', test_ds, wgt_dir, output_shape=10, input_shape=(32, 32, 3),
...
# buf_cero.to_excel('VGG16_Cifar_all_v_all_exp.xlsx', sheet_name='fichero_707', index=False)
...
buf_cero.to_excel('VGG16_Cifar_base_F_P.xlsx', sheet_name='fichero_707', index=False)
print('buf_cero', buf_cero)
