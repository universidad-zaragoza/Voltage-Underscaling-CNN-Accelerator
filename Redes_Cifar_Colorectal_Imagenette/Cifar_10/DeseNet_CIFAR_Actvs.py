...
# DenseNet = GetNeuralNetworkModel('DenseNet',(150,150,3),10, quantization = False, aging_active=False)
# #
# #
# # # In[8]:
# #
...
#
# score = DenseNet.evaluate(test_ds, verbose=1)
#
# print('Test loss:', score[0])
# print('Test accuracy:', score[1])

#
# score = DenseNet.evaluate(train_ds, verbose=1)
#
# print('Test loss:', score[0])
# print('Test accuracy:', score[1])

wgt_dir= ('../Trained_Weights_cifar/DenseNet/weights.data')


# df = QuantizationEffect('DenseNet',test_ds,wgt_dir,(150,150,3),10,batch_size)
#
#
# quantizacion=pd.DataFrame(df)
#
# quantizacion.to_excel('quantizacion.xlsx', sheet_name='fichero_707', index=False)
# #save_obj(df,'Data/Quantization/DenseNet_cifar/Quantization_DenseNet_cifar')
#
#
# # score = DenseNet.evaluate(train_ds, verbose=1)
# #
# # print('Test loss:', score[0])
# # print('Test accuracy:', score[1])
# print(str()+' Quantización completada DenseNet_Cifar: ', datetime.now().strftime("%H:%M:%S"))
...
loss='sparse_categorical_crossentropy'
optimizer = Adam(0.0001)
WeightQuantization(model=DenseNet, frac_bits=3, int_bits=12)
DenseNet.compile(optimizer=optimizer, loss=loss, metrics='accuracy')
loss, acc = DenseNet.evaluate(test_ds)
...
for i in range(1):
    ...
    loss, acc = CheckAccuracyAndLoss('DenseNet', test_ds, wgt_dir, output_shape=10, input_shape=(150, 150, 3),
                                     act_frac_size=6, act_int_size=9, wgt_frac_size=3, wgt_int_size=12,
...
# buf_cero.to_excel('DenseNet_Cifar_all_v_all_exp.xlsx', sheet_name='fichero_707', index=False)
...
buf_cero.to_excel('DenseNet_Cifar_base_F_P_6_9_3_12.xlsx', sheet_name='fichero_707', index=False)
