...
from Stats_Cifar import WeightQuantization, ActivationStats, CheckAccuracyAndLoss, QuantizationEffect, GetReadAndWrites
...
Xception = GetNeuralNetworkModel('Xception',(32,32,3),10, quantization = False, aging_active=False)
...
wgt_dir= ('../Trained_Weights_cifar/Xception/weights.data')




# df = QuantizationEffect('Xception',test_ds,wgt_dir,(32,32,3),10,batch_size)
# #
# #
# quantizacion=pd.DataFrame(df)
# # #
# quantizacion.to_excel('quantizacion.xlsx', sheet_name='fichero_707', index=False)
# #save_obj(df,'Data/Quantization/Xception_cifar/Quantization_Xception_cifar')
# #
batch_size = 28
Xception = GetNeuralNetworkModel('Xception',(32,32,3),10, quantization = False, aging_active=False)
...
loss='sparse_categorical_crossentropy'
optimizer = Adam(0.0001)
WeightQuantization(model=Xception, frac_bits=11, int_bits=4)
...
for i in range(1):
    ...
    loss, acc = CheckAccuracyAndLoss('Xception', test_ds, wgt_dir, output_shape=10, input_shape=(32, 32, 3),
                                     act_frac_size=8, act_int_size=7, wgt_frac_size=11, wgt_int_size=4,
...
#
#     loss, acc = CheckAccuracyAndLoss('Xception', test_ds, wgt_dir, output_shape=10, input_shape=(32, 32, 3),
#                                      act_frac_size=14, act_int_size=1, wgt_frac_size=15, wgt_int_size=0,
...
#
#     loss, acc = CheckAccuracyAndLoss('Xception', test_ds, wgt_dir, output_shape=10, input_shape=(32, 32, 3),
#                                      act_frac_size=13, act_int_size=3, wgt_frac_size=15, wgt_int_size=0,
#                                      batch_size=1, verbose=0, aging_active=activation_aging, weights_faults=False,
#                                      faulty_addresses=locs, masked_faults=error_mask)
#     Accs_F.append(acc)
#     fin = time.time()
...
# buf_cero.to_excel('Xception_Cifar_all_v_all_exp.xlsx', sheet_name='fichero_707', index=False)
...
buf_cero.to_excel('Xception_Cifar_base_F_P.xlsx', sheet_name='fichero_707', index=False)
print('buf_cero', buf_cero)
