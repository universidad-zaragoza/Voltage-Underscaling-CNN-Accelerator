...
ResNet = GetNeuralNetworkModel('ResNetOLD',(32,32,3),10, quantization = False, aging_active=False)
...
save_obj(df,'Data/Quantization/ResNet_cifar/Quantization_ResNetOLD_cifar')

ResNet.load_weights(wgt_dir)
