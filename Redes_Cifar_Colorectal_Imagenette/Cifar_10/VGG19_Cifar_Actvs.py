...
wgt_dir= ('../Trained_Weights_cifar/VGG19/weights.data')
...
VGG19 = GetNeuralNetworkModel('VGG19',(32,32,3),10, quantization = False, aging_active=False)
# VGG19.load_weights(wgt_dir).expect_partial()
# loss='sparse_categorical_crossentropy'
# optimizer = Adam(0.0001)
# WeightQuantization(model=VGG19, frac_bits=14, int_bits=1)
...
# #
# #
# score = VGG19.evaluate(train_ds, verbose=1)
# #
...
for i in range(1):
    ...
    loss, acc = CheckAccuracyAndLoss('VGG19', test_ds, wgt_dir, output_shape=10, input_shape=(32, 32, 3),
                                     act_frac_size=13, act_int_size=2, wgt_frac_size=15, wgt_int_size=0,
...
# buf_cero.to_excel('VGG19_Cifar_all_v_all_exp.xlsx', sheet_name='fichero_707', index=False)
...
buf_cero.to_excel('VGG19_Cifar_base_F_P.xlsx', sheet_name='fichero_707', index=False)
print('buf_cero', buf_cero)
